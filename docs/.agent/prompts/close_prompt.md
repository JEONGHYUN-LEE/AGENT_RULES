...
Ensure `docs/commits` exists; create it if not. Create a folder inside it named with the current time (e.g. `YYYY-MM-DD_HH:mm:ss` like `docs/commits/2025-03-10_14:30:00`). Time zone has to be KST (korea).
When you need the current time, do not guess.
