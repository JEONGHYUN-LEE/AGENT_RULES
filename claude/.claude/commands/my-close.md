...
After completion, summarize what was done and notify the user. In the notice, include:
- The exact name of the newly created folder under `docs/commits/` (format: `timestamp_shortsummary`).
- A short summary in Korean of the work completed, 15 characters or less.
